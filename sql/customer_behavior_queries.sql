/* ============================================================
   Customer Behavior Analysis — SQL Business Questions
   Dataset : data/cleaned/customer.csv
   ============================================================ */

CREATE DATABASE CustomerBehaviorQ;
GO
USE CustomerBehaviorDB;
GO

-- Quick sanity check after loading the cleaned CSV into `customer`
SELECT TOP 10 *
FROM customer;
...
-- ------------------------------------------------------------
-- Q4. Compare the average purchase amount between Standard and
--     Express Shipping.
-- ------------------------------------------------------------
